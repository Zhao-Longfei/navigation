...
def random_distance(image,num_test):
    ...
    '''
    d = 0.1 * random.randint(0,50)
    alpha = 0#0.1 * random.randint(0, 60)
...
while True and num_test<500:
    ...
    img, d =random_distance(image,num_test)
    d = round(d , 1)
    cv2.imshow('Discrimination ability experiment', img)
...
#print("no:",num_no)
#print(data)
output = open('data_distance.xls','w',encoding='gbk')
